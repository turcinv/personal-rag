---
name: code-reviewer
description: Reviews the personal-rag backend API branch before the PR — correctness, security (JWT + subprocess indexing), and adherence to docs/archive/BACKEND_API_PLAN.md guardrails. Read-only verification; reports findings, does not edit code. Use as the final step before opening the PR.
...
**Guardrail compliance (docs/archive/BACKEND_API_PLAN.md):**
